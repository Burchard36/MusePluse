...
public class ItemUtils {
    ...
    public static ItemStack modify(final ItemStack itemStack, final String displayName) {
        ...
        assert meta != null;
        meta.setDisplayName(StringUtils.convert(displayName));
    ...
    public static ItemStack modify(final ItemStack itemStack, final String... lore) {
        ...
        for (String line : lore) {
            newLore.add(StringUtils.convert(line));
        }
    ...
    public static ItemStack createItemStack(
        ...
        if (displayName != null) itemMeta.setDisplayName(StringUtils.convert(displayName));
        if (lore != null) {
            final List<String> itemLore = new ArrayList<>();
            for (String loreLine : lore) {
                if (loreLine == null) continue;
                itemLore.add(StringUtils.convert(loreLine));
            }
